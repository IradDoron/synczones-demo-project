...
const mockDataTasks: Task[] = [
	...
	{
		id: 29,
		title: 'Learn i18n in next',
		url: 'learn-i18n-in-next--29',
		taskType: 'General',
		description:
			'Learn how to implement i18n in Next.js to support multiply languages',
		taskSteps: [],
		status: 'Not Started',
		learningResourceId: 0,
		relatedGoalsIds: [3],
		...
		attachments: [
			...
			},
			{
				id: 2,
				title: 'Article',
				url: 'https://blog.stackademic.com/the-ultimate-guide-to-internationalization-with-next-js-13-eb1be3d1a9e2',
				notes: '',
			},
			{
				id: 3,
				title: 'Tutorial',
				url: 'https://www.youtube.com/watch?v=pKolfZFW3gs&ab_channel=TuomoKankaanp%C3%A4%C3%A4',
				notes: '',
			},
		],
		labels: [],
		createDate: '2023-09-29T08:07:48.384Z',
		startDate: null,
		completedDate: null,
		dueDate: null,
		recurrence: {
