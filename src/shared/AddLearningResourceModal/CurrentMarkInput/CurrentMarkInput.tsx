...
const CurrentMarkInput = ({ setFormData, formData, marktype }: Props) => {
	...
	switch (getMarkTypeFormated(marktype)) {
		...
		default:
			return (
				<input type='text' name='currentMark' onChange={handleTextChange} />
			);
	}
};
